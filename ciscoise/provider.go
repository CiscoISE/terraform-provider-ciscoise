...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"ciscoise_sg_to_vn_to_vlan_bulk_request":                               resourceSgToVnToVLANBulkRequest(),
			"ciscoise_sgt_bulk_request":                                            resourceSgtBulkRequest(),
			"ciscoise_sg_mapping_group_bulk_request":                               resourceSgMappingGroupBulkRequest(),
			"ciscoise_sg_mapping_bulk_request":                                     resourceSgMappingBulkRequest(),
			"ciscoise_sg_acl_bulk_request":                                         resourceSgACLBulkRequest(),
			"ciscoise_device_administration_global_exception_rules_reset_hitcount": resourceDeviceAdministrationGlobalExceptionRulesResetHitcount(),
			"ciscoise_device_administration_local_exception_rules_reset_hitcount":  resourceDeviceAdministrationLocalExceptionRulesResetHitcount(),
			"ciscoise_device_administration_authorization_reset_hitcount":          resourceDeviceAdministrationAuthorizationResetHitcount(),
			"ciscoise_device_administration_authentication_reset_hitcount":         resourceDeviceAdministrationAuthenticationResetHitcount(),
			"ciscoise_network_access_authorization_rules_reset_hitcount":           resourceNetworkAccessAuthorizationRulesResetHitcount(),
			"ciscoise_network_access_authentication_rules_reset_hitcount":          resourceNetworkAccessAuthenticationRulesResetHitcount(),
			"ciscoise_sxp_vpns_bulk_request":                                       resourceSxpVpnsBulkRequest(),
			"ciscoise_sxp_local_bindings_bulk_request":                             resourceSxpConnectionsBulkRequest(),
			"ciscoise_sxp_connections_bulk_request":                                resourceSxpConnectionsBulkRequest(),
			"ciscoise_network_device_bulk_request":                                 resourceNetworkDeviceBulkRequest(),
			"ciscoise_guest_user_bulk_request":                                     resourceGuestUserBulkRequest(),
			"ciscoise_endpoint_bulk_request":                                       resourceEndpointBulkRequest(),
			"ciscoise_egress_matrix_cell_bulk_request":                             resourceEgressMatrixCellBulkRequest(),
			"ciscoise_anc_policy_bulk_request":                                     resourceAncPolicyBulkRequest(),
			"ciscoise_anc_endpoint_bulk_request":                                   resourceAncEndpointBulkRequest(),
			"ciscoise_device_administration_policy_set_reset_hitcount":             resourceDeviceAdministrationPolicySetResetHitcount(),
			...
			"ciscoise_device_administration_authorization_rules_update":            resourceDeviceAdministrationAuthorizationRulesUpdateUpdate(),
			...
			"ciscoise_network_access_authorization_rules_update":                   resourceNetworkAccessAuthorizationRulesUpdateUpdate(),
			...
			"ciscoise_custom_attributes":                                           resourceCustomAttributes(),
			"ciscoise_custom_attributes_rename":                                    resourceCustomAttributesRename(),
			"ciscoise_duo_identity_sync":                                           resourceDuoIDentitySync(),
			"ciscoise_duo_identity_sync_status":                                    resourceDuoIDentitySyncStatus(),
			"ciscoise_duo_mfa":                                                     resourceDuoMfa(),
			"ciscoise_duo_mfa_testconnection":                                      resourceDuoMfaTestconnection(),
			"ciscoise_endpoints":                                                   resourceEndpoints(),
			"ciscoise_endpoints_bulk":                                              resourceEndpointsBulk(),
			"ciscoise_endpoints_task":                                              resourceEndpointsTask(),
			"ciscoise_ipsec":                                                       resourceIPsec(),
			"ciscoise_ipsec_bulk":                                                  resourceIPsecBulk(),
			"ciscoise_ipsec_delete":                                                resourceIPsecDelete(),
			"ciscoise_ipsec_disable":                                               resourceIPsecDisable(),
			"ciscoise_ipsec_enable":                                                resourceIPsecEnable(),
			"ciscoise_px_grid_direct":                                              resourcePxGridDirect(),
			"ciscoise_px_grid_direct_sync":                                         resourcePxGridDirectSync(),
			"ciscoise_px_grid_direct_test_connector":                               resourcePxGridDirectTestConnector(),
			"ciscoise_reservation":                                                 resourceReservation(),
			"ciscoise_stop_replication":                                            resourceStopReplication(),
			"ciscoise_trustsec_nbar_app":                                           resourceTrustsecNbarApp(),
			"ciscoise_trustsec_sg_vn_mapping":                                      resourceTrustsecSgVnMapping(),
			"ciscoise_trustsec_sg_vn_mapping_bulk_create":                          resourceTrustsecSgVnMappingBulkCreate(),
			"ciscoise_trustsec_sg_vn_mapping_bulk_delete":                          resourceTrustsecSgVnMappingBulkDelete(),
			"ciscoise_trustsec_sg_vn_mapping_bulk_update":                          resourceTrustsecSgVnMappingBulkUpdate(),
			"ciscoise_trustsec_vn":                                                 resourceTrustsecVn(),
			"ciscoise_trustsec_vn_bulk_create":                                     resourceTrustsecVnBulkCreate(),
			"ciscoise_trustsec_vn_bulk_delete":                                     resourceTrustsecVnBulkDelete(),
			"ciscoise_trustsec_vn_bulk_update":                                     resourceTrustsecVnBulkUpdate(),
			"ciscoise_trustsec_vn_vlan_mapping":                                    resourceTrustsecVnVLANMapping(),
			"ciscoise_trustsec_vn_vlan_mapping_bulk_create":                        resourceTrustsecVnVLANMappingBulkCreate(),
			"ciscoise_trustsec_vn_vlan_mapping_bulk_delete":                        resourceTrustsecVnVLANMappingBulkDelete(),
			"ciscoise_trustsec_vn_vlan_mapping_bulk_update":                        resourceTrustsecVnVLANMappingBulkUpdate(),
			"ciscoise_upgrade_proceed":                                             resourceUpgradeProceed(),
			"ciscoise_upgrade_stage_cancel":                                        resourceUpgradestageCancel(),
			"ciscoise_upgrade_stage_start":                                         resourceUpgradestageStart(),
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"ciscoise_active_directories_info":                                    dataSourceActiveDirectoriesInfo(),
			"ciscoise_ad_groups_info":                                             dataSourceAdGroupsInfo(),
			"ciscoise_configuration":                                              dataSourceConfiguration(),
			"ciscoise_custom_attributes":                                          dataSourceCustomAttributes(),
			"ciscoise_dataconnect_info":                                           dataSourceDataconnectInfo(),
			"ciscoise_dataconnect_settings":                                       dataSourceDataconnectSettings(),
			"ciscoise_duo_identity_sync":                                          dataSourceDuoIDentitySync(),
			"ciscoise_duo_identity_sync_cancel_info":                              dataSourceDuoIDentitySyncCancelInfo(),
			"ciscoise_duo_identitysync_sync_info":                                 dataSourceDuoIDentitysyncSyncInfo(),
			"ciscoise_duo_mfa":                                                    dataSourceDuoMfa(),
			"ciscoise_endpoints":                                                  dataSourceEndpoints(),
			"ciscoise_endpoints_device_type_info":                                 dataSourceEndpointsDeviceTypeInfo(),
			"ciscoise_ipsec_certificates_info":                                    dataSourceIPsecCertificatesInfo(),
			"ciscoise_ipsec_info":                                                 dataSourceIPsecInfo(),
			"ciscoise_px_grid_direct":                                             dataSourcePxGridDirect(),
			"ciscoise_px_grid_direct_dictionary_info":                             dataSourcePxGridDirectDictionaryInfo(),
			"ciscoise_px_grid_direct_sync":                                        dataSourcePxGridDirectSync(),
			"ciscoise_reservation":                                                dataSourceReservation(),
			"ciscoise_stop_replication":                                           dataSourceStopReplication(),
			...
			"ciscoise_upgrade_proceed":                                            dataSourceUpgradeProceed(),
