...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"ciscoise_pan_ha_update":                                               dataSourcePanHaUpdate(),
			...
			"ciscoise_trustsec_sg_vn_mapping_bulk_create":                          dataSourceTrustsecSgVnMappingBulkCreate(),
			"ciscoise_trustsec_sg_vn_mapping_bulk_delete":                          dataSourceTrustsecSgVnMappingBulkDelete(),
			"ciscoise_trustsec_sg_vn_mapping_bulk_update":                          dataSourceTrustsecSgVnMappingBulkUpdate(),
			"ciscoise_trustsec_vn":                                                 dataSourceTrustsecVn(),
			"ciscoise_trustsec_vn_bulk_create":                                     dataSourceTrustsecVnBulkCreate(),
			"ciscoise_trustsec_vn_bulk_delete":                                     dataSourceTrustsecVnBulkDelete(),
			"ciscoise_trustsec_vn_bulk_update":                                     dataSourceTrustsecVnBulkUpdate(),
			"ciscoise_trustsec_vn_vlan_mapping":                                    dataSourceTrustsecVnVLANMapping(),
			"ciscoise_trustsec_vn_vlan_mapping_bulk_create":                        dataSourceTrustsecVnVLANMappingBulkCreate(),
			"ciscoise_trustsec_vn_vlan_mapping_bulk_delete":                        dataSourceTrustsecVnVLANMappingBulkDelete(),
			"ciscoise_trustsec_vn_vlan_mapping_bulk_update":                        dataSourceTrustsecVnVLANMappingBulkUpdate(),
			...
			"ciscoise_licensing_registration_create":                               dataSourceLicensingRegistrationCreate(),
			"ciscoise_licensing_smart_state":                                       dataSourceLicensingSmartState(),
			"ciscoise_licensing_smart_state_create":                                dataSourceLicensingSmartStateCreate(),
			"ciscoise_licensing_tier_state":                                        dataSourceLicensingTierState(),
			"ciscoise_licensing_tier_state_create":                                 dataSourceLicensingTierStateCreate(),
			"ciscoise_hotpatch":                                                    dataSourceHotpatch(),
			"ciscoise_hotpatch_install":                                            dataSourceHotpatchInstall(),
			"ciscoise_hotpatch_rollback":                                           dataSourceHotpatchRollback(),
			"ciscoise_patch":                                                       dataSourcePatch(),
			"ciscoise_patch_install":                                               dataSourcePatchInstall(),
			"ciscoise_patch_rollback":                                              dataSourcePatchRollback(),
			...
			"ciscoise_node_primary_to_standalone":                                  dataSourceNodePrimaryToStandalone(),
		},
