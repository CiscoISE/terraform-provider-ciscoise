...
func TestValidatorsValidateStringIsValueFunc(t *testing.T) {
...
func TestValidatorsValidateStringHasValueFunc(t *testing.T) {
	reqValues := []string{"order", "des", "asc"}
	validStrings := []string{"order", "des", "asc"}
	invalidStrings := []string{"Order", "desc", "Asc"}
...
func TestValidatorsValidateIntegerInRange(t *testing.T) {
...
func TestValidatorsValidateIntegerGeqThan0(t *testing.T) {
	v := 1
...
func TestValidatorsValidateStringMatchesPattern(t *testing.T) {
