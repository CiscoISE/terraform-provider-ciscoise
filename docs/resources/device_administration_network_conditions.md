...
- `link` (List of Object) (see [below for nested schema](#nestedatt--parameters--conditions--link))

<a id="nestedatt--parameters--conditions--link"></a>
### Nested Schema for `parameters.conditions.link`
